...
/** @brief Predict the model accuracy after inference
*
* Calculates accuracy based on equality between class label and prediction.
*
* @param *model_acc     Float to save accuracy on
* @param num_data       Number of datapoints
* @param num_output_neurons    Number of classes
* @param *data_label    Array containing labels
* @param *model_pred    Array containing predictions
*/
void predict_model_acc(float *model_acc, int num_data, int num_output_neurons, float *data_label, float *model_pred);

/** @brief Predict the model accuracy after inference for binary outcomes
*
* Calculates accuracy based on equality between label prediction based on a threshold (usually 0.5)
*
* @param *model_acc     Float to save accuracy on
* @param num_data       Number of datapoints
* @param threshold      Threshold over which prediction should be counted as 1
* @param *data_label    Array containing labels
* @param *model_pred    Array containing predictions
*/
void predict_model_binary_acc(float *model_acc, int num_data, const float threshold, float *data_label, float *model_pred);
